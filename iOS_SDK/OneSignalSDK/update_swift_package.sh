...
SWIFT_PM_URL_LINE="          url: \"https:\/\/github.com\/Saturn-Technologies\/OneSignal-iOS-SDK\/releases\/download\/${VERSION_NUMBER}\/OneSignalCore.xcframework.zip\","
...
SWIFT_PM_URL_LINE="          url: \"https:\/\/github.com\/Saturn-Technologies\/OneSignal-iOS-SDK\/releases\/download\/${VERSION_NUMBER}\/OneSignalOutcomes.xcframework.zip\","
...
SWIFT_PM_URL_LINE="          url: \"https:\/\/github.com\/Saturn-Technologies\/OneSignal-iOS-SDK\/releases\/download\/${VERSION_NUMBER}\/OneSignalExtension.xcframework.zip\","
...
SWIFT_PM_URL_LINE="          url: \"https:\/\/github.com\/Saturn-Technologies\/OneSignal-iOS-SDK\/releases\/download\/${VERSION_NUMBER}\/OneSignal.xcframework.zip\","
